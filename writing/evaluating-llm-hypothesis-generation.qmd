...
image-alt: "Austin Morrissey with Drew Weissman"
...
But open heart surgery is not as esay as it seems.

![](/images/writing/evaluating-llm-hypothesis/01-cardiac-stent.png){fig-alt="Diagram of coronary artery disease progressing from a healthy artery through plaque buildup to severe obstruction." loading="lazy" decoding="async"}

![](/images/writing/evaluating-llm-hypothesis/02-bypass.png){fig-alt="Diagram comparing stent placement through a coronary blockage with bypass grafting around it." loading="lazy" decoding="async"}
...
![](/images/writing/evaluating-llm-hypothesis/03-mrna-rejection-cartoon.png){fig-alt="Cartoon showing mRNA researchers facing journal rejection and dismissal in favor of protein therapy." loading="lazy" decoding="async"}

<div class="quarto-video ratio ratio-16x9">
<iframe src="https://www.youtube-nocookie.com/embed/-3x4IMdeFdI?rel=0" title="Nobel Prize Winners Dr. Katalin Karikó and Dr. Drew Weissman | The Story Behind mRNA Vaccines" aria-label="Interview with Katalin Karikó and Drew Weissman about the story behind mRNA vaccines" loading="lazy" referrerpolicy="strict-origin-when-cross-origin" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
![](/images/writing/evaluating-llm-hypothesis/04-kariko-weissman.jpg){fig-alt="Austin Morrissey with Drew Weissman" loading="lazy" decoding="async"}
