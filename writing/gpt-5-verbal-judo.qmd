...
![](/images/writing/gpt-5-verbal-judo/06-metr-o3.png){fig-alt="METR's GPT-5 evaluation page, with a highlighted note that OpenAI's comms and legal teams reviewed and approved it before release"}

![](/images/writing/gpt-5-verbal-judo/07-metr-gpt5.png){fig-alt="A GPT-5 chat reply claiming there is no evidence the METR report was reviewed by OpenAI"}
