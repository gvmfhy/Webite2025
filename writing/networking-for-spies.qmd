...
canonical-url: https://austinpatrick.substack.com/p/networking-for-spies-translating
---
...
![Russian Cyrillic book text extracted to a dark terminal, with "[PAGE 14]" and "[PAGE 15]" markers separating the chapter "О чем мы расскажем" — the raw output of the PyPDF2 extraction step.](/images/writing/networking-for-spies/01-code-visualization.png)
...
![Anna's Archive search-result page for the book "Нетворкинг для разведчиков. Как извлечь пользу из любого знакомства" by Елена Вавилова and Андрей Безруков, showing the listing details, table of contents, and a small cover thumbnail.](/images/writing/networking-for-spies/02-code-implementation.png)
...
![A Claude Code terminal session (v2.0.15, Sonnet 4.5) where Austin describes screenshotting and translating each page of a Cyrillic PDF and asks how to automate the task, with Claude offering to break the problem down.](/images/writing/networking-for-spies/03-terminal-output.png)
