...
![](/images/writing/networking-for-spies/01-code-visualization.png){fig-alt="Terminal showing extracted Cyrillic book text"}
...
![](/images/writing/networking-for-spies/02-code-implementation.png){fig-alt="Anna's Archive listing for the book"}
...
![](/images/writing/networking-for-spies/03-terminal-output.png){fig-alt="Claude Code terminal session"}
